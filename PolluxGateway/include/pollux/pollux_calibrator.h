 ...
 *
 */
#ifndef __POLLUX_CALIBRATOR_H__
#define __POLLUX_CALIBRATOR_H__
...
/// Class that defines the algorithm to process outgoing and incoming frames to calibrate a Pollux Sensor Zigbee module
class Pollux_calibrator : public Pollux_configurator {
