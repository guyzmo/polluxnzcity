...
long long unsigned int Pollux_calibrator::next_module() {
...
char* Pollux_calibrator::next_measure(unsigned long long int module, bool inner) {
...
void Pollux_calibrator::store_measure(xbee::Xbee_result& payload) {
...
void Pollux_calibrator::push_data(long long unsigned int module) {
